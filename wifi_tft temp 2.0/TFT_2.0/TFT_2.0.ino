...
//////////////////////////////////// WiFi Manager /////////////////////////////////////////////////
  ...
  if(!wm.autoConnect("COM_EDU||44-703")){
...
//////////////////////////////////// WiFi Manager /////////////////////////////////////////////////
  ...
  delay(100);
  Serial.println("connected__already__WiFi");
  Serial.println("now conneted WiFi.");
...
// Assume myData.temp is a float value
int temperature = 10;

//////////////////////////////////////////////////////////////////
void ui_reset() {
  lv_label_set_text(ui_Label1, temp.c_str());
  lv_obj_add_event_cb(ui_Arc1, ui_event_Arc1, LV_EVENT_RELEASED, NULL);
}
/////////////////////////////////////////////////////////////////
